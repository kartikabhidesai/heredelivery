...
class Comment_report extends CI_Controller {
...
public function index()
  {
     $data["view"]=$this->Home_model->get_tbl_data_order('report_comment',array("is_delete"=>0));
     $this->load->view('admin/report_comment',$data);
 }
 ...
 {
     $comment_data=$this->Home_model->get_single_row('comment',array("id"=>$comment_id));
 ...
 public function view_post($comment_id)
 {
       $data["view"]=$this->Home_model->get_single_row('comment',array("id"=>$comment_id));
 ...
 public function delete($id,$list_id)
    {
		$this->Home_model->update('comment',$id,array("is_delete"=>1));
		$this->Home_model->update('report_comment',$list_id,array("is_delete"=>1));
		$this->session->set_flashdata('message','Comment Delete Successfully');
		redirect('admin/Comment_report');
    }
