...
<div class="main-content">
   <div class="content-wrapper"><!--Statistics cards Starts-->
      ...
      <div class="row">
    <div class="col-12">
        <div class="content-header">Report post
                             ...
                             {  ?>
                                  ...
                                  <?php $CI=& get_instance(); ?>
                                   <td><?php echo $CI->get_user_full_name($vw->user_id); ?></td>
                                    ...
                                    <td><a href="<?php echo base_url('admin/Post_Report/view_post/').$vw->post_id; ?>"><i class="fa fa-eye font-medium-3 mr-2"></i></a></td>
                                     <td><a class="danger p-0" title="Delete" href="<?php echo base_url('admin/Post_Report/delete/'.$vw->post_id.'/'.$vw->id); ?>" onClick="return confirm('are you sure you want to delete..?')">
