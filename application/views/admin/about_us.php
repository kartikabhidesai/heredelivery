...
<div class="main-panel">
    <div class="main-content">
        <div class="content-wrapper"><!--Statistics cards Starts-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="content-header">About Us 
                    </div>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-12"  style="float:left">
                                                <div class="form-group">
                                                    <label >Detail</label>
                                                    <textarea type="text" name="detail" rows="5" id="detail" required class="form-control" ><?php if (!empty($view)) {
                        echo $view->detail;
                    } ?></textarea>
                                                </div>
                                        ...
                                        <div class="form-actions center">
                                            <button type="submit" name="<?php if (!empty($view)) {
                        echo "update";
                    } else {
                        echo "add";
                    } ?>" value="save" class="btn btn-raised btn-primary">
